...
in
  {
    ...
    NotebookNavigator-nvim =
      super.NotebookNavigator-nvim.overrideAttrs {
      };
    ...
    nvim-impairative =
      super.nvim-impairative.overrideAttrs {
      };
    ...
    quicker-nvim =
      super.quicker-nvim.overrideAttrs {
      };
    ...
    roslyn-nvim =
      super.roslyn-nvim.overrideAttrs {
      };
    ...
    scretch-nvim =
      super.scretch-nvim.overrideAttrs {
      };
    ...
    telescope-cc-nvim = super.telescope-cc-nvim.overrideAttrs {
      dependencies = with self; [
        telescope-nvim
      ];
    };
